...
# from openrlhf.utils import get_llm_for_sequence_regression
...
def train(args):
    ...
    # configure tokenizer
    tokenizer = get_tokenizer(args.pretrain, model, "right", strategy, use_fast=not args.disable_fast_tokenizer)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--neg_weight", type=float, default=1.0, help="loss weight for negative samples, default 1.0")
    parser.add_argument("--mono_weight", type=float, default=1.0, help="loss weight for turn aware samples, default 1.0")
